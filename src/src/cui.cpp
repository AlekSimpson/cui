...
//        int mx, my;
//        SDL_GetMouseState(&mx, &my);
//        bool mouse_in_view = is_inside_scrollview(&curr_scene, event->wheel.y);
//
//        scrollview_t curr_sv = curr_scene.special_views[0].scrollview;
...
//          curr_scene.special_views[0].scrollview.leading_y += event->wheel.y * 20;
...
//  /// view definitions
//  //
//  vstack_t main_root_stack = vstack(0, 0, 0, 20, 20, LEADING); // the scenes root stack always starts at coordinates (0, 0)
//  main_labels[0]  = vstack_add_label_offset(&main_root_stack, ren, font_title, "Characters", 250, 100, 255, 255, 255, 85, 0);
//
//  special_view_u main_sv_view = vstack_add_scrollview_color(&main_root_stack, ID_STATE, 10, 10, 400, 700, create_color(113, 150, 168)); // scrollview_t
//
//  // attach to debug
//  attach_to_ui_debug(SCROLLVIEW_T, &main_sv_view);
//
//  main_special_views[0] = main_sv_view; 
//  main_buttons[0] = vstack_add_button(&main_root_stack, ren, 400, 100, 74, 101, 114, "New Sheet", font24);
//
//  main_buttons[1] = scrollview_add_button_ac(&main_sv_view.scrollview, ren, 300, 125, &SECONDARY_COLOR, "item A", font24, CENTER);
//  main_buttons[2] = scrollview_add_button_ac(&main_sv_view.scrollview, ren, 300, 125, &SECONDARY_COLOR, "item B", font24, CENTER);
//  main_buttons[3] = scrollview_add_button_ac(&main_sv_view.scrollview, ren, 300, 125, &SECONDARY_COLOR, "item C", font24, CENTER);
//  main_buttons[4] = scrollview_add_button_ac(&main_sv_view.scrollview, ren, 300, 125, &SECONDARY_COLOR, "item D", font24, CENTER);
//  main_buttons[5] = scrollview_add_button_ac(&main_sv_view.scrollview, ren, 300, 125, &SECONDARY_COLOR, "item E", font24, CENTER);
//
//  hstack_t button_hstack = vstack_add_hstack(&main_root_stack, 0, 0, 50, 400, 100, MIDDLE); // 60
//
//  main_buttons[6] = hstack_add_button(&button_hstack, ren, 175, 100, 74, 101, 114, "Settings", font24);
//  main_buttons[7] = hstack_add_button(&button_hstack, ren, 175, 100, 74, 101, 114, "Quit", font24);
//
//  // MARK: SCENES
//  scene_t scenes[2];
...
//
//  printf("first scroll y: %d\n", main_sv_view.scrollview.scroll_y);
//
//  AppState as;
//  as.quit = false;
//  as.scenes = scenes;
